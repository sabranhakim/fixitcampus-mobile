...
import 'package:fixitcampus_mobile/src/screens/create_ticket_screen.dart'; // Import CreateTicketScreen
...
class _TicketListScreenState extends State<TicketListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold( // Wrap with Scaffold to use FloatingActionButton
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CreateTicketScreen(token: widget.token),
            ),
          );
          _refreshTickets(); // Refresh tickets after returning from CreateTicketScreen
        },
